...
public class AzureAppServiceRemoteStoreService implements NgManifestService {
        ...
        K8sManifest.builder()
            ...
            .store(ParameterField.createValueField(
                StoreConfigWrapper.builder()
                    ...
                    .spec(manifestMigrationService.getGitStoreWithFilePaths(gitFileConfig, connector))
                    .build()))
            .build();
