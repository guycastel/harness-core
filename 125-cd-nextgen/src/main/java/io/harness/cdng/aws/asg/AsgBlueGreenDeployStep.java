...
@Slf4j
public class AsgBlueGreenDeployStep extends CdTaskChainExecutable implements AsgStepExecutor {
  ...
  public TaskChainResponse executeAsgPrepareRollbackDataTask(Ambiance ambiance,
    ...
    TaskType taskType = getPrepareRollbackTaskType(asgBlueGreenDeployStepParameters, asgInfraConfig);
  ...
  @VisibleForTesting
  TaskType getPrepareRollbackTaskType(
