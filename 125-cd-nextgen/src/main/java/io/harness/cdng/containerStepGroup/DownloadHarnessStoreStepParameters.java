...
@TypeAlias("downloadHarnessStoreStepParameters")
@RecasterAlias("io.harness.cdng.containerStepGroup.DownloadHarnessStoreStepParameters")
public class DownloadHarnessStoreStepParameters
