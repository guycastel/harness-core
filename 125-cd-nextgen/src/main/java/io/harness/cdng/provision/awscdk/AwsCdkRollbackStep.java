...
public class AwsCdkRollbackStep extends AbstractContainerStepV2<StepElementParameters> {
  ...
  public ParameterField<List<TaskSelectorYaml>> getStepDelegateSelectors(SpecParameters stepElementParameters) {
    AwsCdkRollbackStepParameters rollbackStepParameters = (AwsCdkRollbackStepParameters) stepElementParameters;
    return rollbackStepParameters.getDelegateSelectors();
  }
}
