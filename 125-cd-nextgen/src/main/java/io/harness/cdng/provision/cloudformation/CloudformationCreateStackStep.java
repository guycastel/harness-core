...
@Slf4j
public class CloudformationCreateStackStep extends CdTaskChainExecutable implements CloudformationStepExecutor {
  ...
  @Override
  public TaskChainResponse executeCloudformationTask(Ambiance ambiance, StepBaseParameters stepParameters,
