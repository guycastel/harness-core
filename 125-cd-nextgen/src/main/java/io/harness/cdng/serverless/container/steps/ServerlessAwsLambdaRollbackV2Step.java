...
public class ServerlessAwsLambdaRollbackV2Step extends AbstractContainerStepV2<StepElementParameters> {
  ...
  public UnitStep getSerialisedStep(Ambiance ambiance, StepElementParameters stepElementParameters, String accountId,
    ...
    Map<String, String> envVarMap = serverlessV2PluginInfoProviderHelper.getEnvironmentVariables(
        ambiance, serverlessAwsLambdaRollbackV2StepParameters);
  ...
  public ParameterField<List<TaskSelectorYaml>> getStepDelegateSelectors(SpecParameters stepElementParameters) {
    ServerlessAwsLambdaRollbackV2StepParameters lambdaRollbackV2StepParameters =
        (ServerlessAwsLambdaRollbackV2StepParameters) stepElementParameters;
    return lambdaRollbackV2StepParameters.getDelegateSelectors();
  }
}