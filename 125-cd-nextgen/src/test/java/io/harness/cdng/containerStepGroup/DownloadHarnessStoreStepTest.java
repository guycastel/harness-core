...
public class DownloadHarnessStoreStepTest extends CategoryTest {
  ...
  public void testGetStepExecutionTelemetryEventDTO() {
    ...
    StepExecutionTelemetryEventDTO stepExecutionTelemetryEventDTO =
        downloadHarnessStoreStep.getStepExecutionTelemetryEventDTO(ambiance, stepElementParameters);

    assertThat(stepExecutionTelemetryEventDTO.getStepType()).isEqualTo(DownloadHarnessStoreStep.STEP_TYPE.getType());
  }
}