...
public class AwsCdkBootstrapStepTest extends CategoryTest {
  ...
  @InjectMocks AwsCdkBootstrapStep awsCdkBootstrapStep;
  ...
  public void testGetSerialisedStep() {
    ...
    StepElementParameters stepElementParameters =
        StepElementParameters.builder()
            ...
            .spec(AwsCdkBootstrapStepParameters.infoBuilder()
    ...
    UnitStep result =
        awsCdkBootstrapStep.getSerialisedStep(ambiance, stepElementParameters, "accountId", "logKey", 6000, "taskId");
