...
public class ServerlessAwsLambdaDeployStepV2Test extends CategoryTest {
  ...
  public void testGetStepExecutionTelemetryEventDTO() {
    ...
    StepExecutionTelemetryEventDTO stepExecutionTelemetryEventDTO =
        serverlessAwsLambdaDeployV2Step.getStepExecutionTelemetryEventDTO(ambiance, stepElementParameters);

    assertThat(stepExecutionTelemetryEventDTO.getStepType())
        .isEqualTo(ServerlessAwsLambdaDeployV2Step.STEP_TYPE.getType());
  }
}