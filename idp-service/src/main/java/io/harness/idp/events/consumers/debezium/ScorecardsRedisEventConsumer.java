...
@Slf4j
@OwnedBy(IDP)
public class ScorecardsRedisEventConsumer extends DebeziumAbstractRedisConsumer implements IdpRedisConsumer {
  @Inject
  public ScorecardsRedisEventConsumer(@Named(IDP_SCORECARDS_REDIS_EVENT_CONSUMER) Consumer redisConsumer,
      QueueController queueController, ScorecardsChangeEventHandler eventHandler,
