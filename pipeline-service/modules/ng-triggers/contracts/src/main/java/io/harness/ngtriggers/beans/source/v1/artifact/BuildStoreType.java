...
public enum BuildStoreType {
  @JsonProperty(YamlSimplConstants.HTTP) HTTP(YamlSimplConstants.HTTP),
  @JsonProperty(YamlSimplConstants.S3) S3(YamlSimplConstants.S3),
  @JsonProperty(YamlSimplConstants.GCS) GCS(YamlSimplConstants.GCS);
