...
public enum GithubReleaseAction implements GitAction {
  ...
  @JsonProperty(YamlSimplConstants.PRE_RELEASE_EVENT_TYPE)
  PRERELEASE("prerelease", YamlSimplConstants.PRE_RELEASE_EVENT_TYPE),
  @JsonProperty(YamlSimplConstants.PUBLISH_EVENT_TYPE) PUBLISH("publish", YamlSimplConstants.PUBLISH_EVENT_TYPE),
  @JsonProperty(YamlSimplConstants.RELEASE_EVENT_TYPE) RELEASE("release", YamlSimplConstants.RELEASE_EVENT_TYPE),
  @JsonProperty(YamlSimplConstants.UNPUBLISH_EVENT_TYPE)
  UNPUBLISH("unpublish", YamlSimplConstants.UNPUBLISH_EVENT_TYPE);
