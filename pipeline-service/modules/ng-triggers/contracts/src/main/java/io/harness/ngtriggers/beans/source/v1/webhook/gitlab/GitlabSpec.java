...
package io.harness.ngtriggers.beans.source.v1.webhook.gitlab;
...
import io.harness.ngtriggers.beans.source.v1.webhook.gitlab.event.GitlabEventSpec;
import io.harness.ngtriggers.beans.source.v1.webhook.gitlab.event.GitlabTriggerEvent;
...
@OwnedBy(PIPELINE)
@Value
public class GitlabSpec implements WebhookTriggerYamlSimplSpec {
