...
import static io.harness.ngtriggers.beans.source.webhook.v2.gitlab.event.GitlabTriggerEvent.MR_COMMENT;
...
import io.harness.ngtriggers.beans.source.v1.webhook.gitlab.action.GitlabMRCommentAction;
...
@OwnedBy(CI)
public class GitlabMRCommentSpec implements GitlabEventSpec {
  String connector;
  String repo;
  List<GitlabMRCommentAction> actions;
