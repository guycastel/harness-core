...
@JsonSubTypes({
  @JsonSubTypes.Type(value = HarnessPRSpec.class, name = PR_EVENT_TYPE)
  , @JsonSubTypes.Type(value = HarnessPushSpec.class, name = PUSH_EVENT_TYPE),
      @JsonSubTypes.Type(value = HarnessIssueCommentSpec.class, name = ISSUE_COMMENT_EVENT_TYPE)
})
@OwnedBy(PIPELINE)
