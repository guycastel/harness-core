...
public class GitXWebhookResourceImpl implements Resource {
  public String GITX_WEBHOOKS = "GITX_WEBHOOKS";

  @Override
  public String getType() {
    return GITX_WEBHOOKS;
  }
  ...
  public ResourceInfo getResourceInfoFromEvent(Message message) {
    ...
    try {
      ...
      log.error(
          "Exception in unpacking EntityChangeDTO for key {} with resource type {}", message.getId(), GITX_WEBHOOKS, e);
    }
